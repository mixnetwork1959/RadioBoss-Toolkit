...
"ro":{"suggested":"Programe sugerate","selected":"Programe selectate","all":"Toate evenimentele","search":"Căutare:","view":"Vizualizare:","select_visible":"Selectează cele vizibile","clear_visible":"Șterge selecția vizibilă","publish_web":"Publică site-ul","open_export":"Deschide folderul de export","choose_export":"Alege folderul de export","save":"Salvează","info":"Programele sugerate indică blocuri muzicale probabil lungi. Selectați un program în stânga și editați aspectul public în dreapta.","publish":"Publicare","event":"Eveniment RadioBOSS","editor":"Editor program public","public_name":"Nume public:","description":"Descriere:","color":"Culoare:","apply":"Aplică","preview":"Previzualizare live","export_folder":"Folder de export","saved":"Folderul de export a fost salvat.","folder":"Folder","open_failed":"Folderul de export nu a putut fi deschis.","generate_failed":"Site-ul nu a putut fi generat.","generated":"Site-ul calendarului public a fost generat.","file":"Fișier","open_hint":"Folosiți „Deschide folderul de export” pentru a vedea locația.","calendar":"Calendar public","save_failed":"Configurația nu a putut fi salvată:","config_saved":"Configurația a fost salvată.","selected_count":"Programe selectate"}}
