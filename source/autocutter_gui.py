...
TEXTS = {
 ...
 ,"ro":{"title":"Auto Cutter","subtitle":"Creează copii corectate dintr-un raport Silence Scanner verificat.","settings":"Setări","language":"Limbă","help":"Ajutor","guide":"Ghid de utilizare","folder_menu":"Deschide folderul Toolkit","about":"Despre Auto Cutter","loading":"Se încarcă raportul Silence Scanner…","start":"Pornește Auto Cutter","open_output":"Deschide folderul de ieșire","open_report":"Deschide raportul de tăiere","missing":"Raportul de scanare nu a fost găsit","run_scanner":"Rulați mai întâi Silence Scanner.","entries":"Raport: {count:,} intrări  •  {date}","output":"Folder de ieșire: {path}","review":"Verificați raportul înainte de a porni Auto Cutter.","read_error":"Raportul de scanare nu a putut fi citit","engine_missing":"Motorul de procesare nu a fost găsit","confirm_title":"Porniți Auto Cutter?","confirm":"Auto Cutter va procesa {count:,} intrări și va crea copii.\n\nFișierele audio originale nu vor fi suprascrise.\n\nContinuați?","running":"Auto Cutter rulează…","processing":"Se procesează fișierul {current:,} din {total:,}…","start_error":"Auto Cutter nu a putut fi pornit.","success":"Auto Cutter s-a încheiat cu succes.","complete":"Procesarea este finalizată. Fișierele originale nu au fost modificate.","failed":"Auto Cutter s-a încheiat cu o eroare. Consultați jurnalul.","failed_msg":"Procesarea nu s-a finalizat cu succes.","language_locked":"Procesarea este în curs."}
}
